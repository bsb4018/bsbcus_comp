...
with DAG(
    ...
    # [END default_args]
    description='Customer Complaints Prediction Project',
    ...
    def data_ingestion(**kwargs):
        from finpred.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact,DataTransformationArtifact,\
