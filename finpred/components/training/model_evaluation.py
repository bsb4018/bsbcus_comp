from finpred.entity.artifact_entity import ModelEvaluationArtifact, DataValidationArtifact, ModelTrainerArtifact
from finpred.entity.config_entity import ModelEvaluationConfig
